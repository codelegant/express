...
router.route("/signup")
    ...
    var params = req.body, username = params.username, password = params.password, passwordAgain = params.password_again;
...
router.route("/signin")
    ...
    .post(function (req, res) {
    var params = req.body, username = params.username, password = params.password;
    sqlPool.getConnection(function (err, connection) {
        if (err) {
            console.error("连接错误");
        }
