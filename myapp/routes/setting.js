...
var router = express.Router(), sqlPool = mysql.createPool({
    host: "localhost",
    user: "root",
    password: "root",
    database: "express"
...
router.route("/account")
    ...
    var data = querystring.parse(req.body.data), oldPassword = data.old_password, password = data.password, passwordAgain = data.password, userId = req.cookies.userId;
        ...
        if (password.length < 6) {
            ...
            sqlPool.getConnection(function (err, connection) {
                ...
                var md5Password = crypto
                    ...
                    .digest("hex"), md5OldPassword = crypto
                    .createHash("md5")
